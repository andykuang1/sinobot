...
def main(argv):
	...
	locator = {
		...
		'template_weapon_type': '(//tbody//tr)[_INDEX_]//img[contains(@class, "eqtypeImg")]',
	...
	for i in range(1, numElements+1):
		...
		itemType = driver.find_element_by_xpath(locator['template_weapon_type'].replace('_INDEX_', str(i))).get_attribute('src')
